#
#  Be sure to run `pod spec lint nb-ios-maps.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.version      = "0.0.1"
  spec.summary      = "A short description of nb-ios-maps."
  ...
  iOS Maps SDK by Nextbillion AI
                   DESC
  ...
  # spec.social_media_url   = "https://twitter.com/Dan"
